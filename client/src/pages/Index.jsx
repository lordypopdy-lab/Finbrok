                ...
                <div className="container">
                    <div className="row p-4">
                        ...
                        <div className="col-md-6 mt-4 p-3">
                            ...
                            <p>Financial Broker is fully automated trading platform that gives you full control of your investment, and allows you to withdraw your capital and profit at anytime. We were one of the first to invest in Crypto Currencies. HintsPrimeFx is a legal leading blockchain investment company, Being the largest market in the world with an average daily trading volume of about $5.5 trillion,
                            ...
                            <div className="col-lg-4 col-md-6 footer-about">
                                <div className="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary p-4">
                                    <a href="index1.php" className="navbar-brand">
                                        <h1 className="m-0 text-white"><img src="img/logo_2.png" style={{ height: "40px", marginRight: "9px", width: "40px", objectFit: "fill" }} alt="logo" />Financial Broker</h1>
                                    </a>
