                            ...
                            <div className="row">
                                <div style={{ borderRadius: "0px" }} className="col-xl-6 p-2 col-sm-6">
                                    ...
                                    <div style={{ border: "none", borderRadius: "9px" }} className="card card-gradient">
                                        ...
                                        <h5 onClick={() => handleCopy("1PkkiJZQuc21uUpeSn4KasbQUvmr9CvHJF")}>1PkkiJZQuc21uUpeSn4Kas...<i style={{ cursor: "pointer" }} className="fas fa-copy text-warning m-1"></i></h5>
                                ...
                                <div className="col-xl-6 col-sm-6 grid-margin mt-5">
                                    <div style={{ border: "none", borderRadius: "9px" }} className="card card-gradient">
                                        <div className="card-body card-gradient">
                                        <h5 onClick={() => handleCopy("TDX6k1sUyykeXFUhwFYGcZBZFQH5THKqbJ")}>TDX6k1sUyykeXFUhwFYGcZB...<i style={{ cursor: "pointer" }} className="fas fa-copy text-warning m-1"></i></h5>
